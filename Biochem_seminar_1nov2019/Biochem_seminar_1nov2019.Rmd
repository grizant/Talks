...
- So I'll share my thoughts on this and discuss 2 relevant biomedical gene expression projects I led.
...
Before we progress to sharing a few projects, I'd like to know briefly what types of bioinformatic/statistical issues & challenges you are facing.
...
- Can prostate cancer therapy resistance be detected from single cell RNA-sequencing (scRNA-seq) of CTCs?
...
* Bioinformatics and many fields rely on many professionals to get the work done.

* Applied statisticians can help with experimental design, modeling, interpretation, inference.

* Something that I'm now interesting is in the use of Bayesian modeling to enhance interdisciplinary collaboration:
	...
	- Students consider taking the new STAT 646 Introduction to Bayesian Statistics. I'll do a project with you and I encourage you to bring your thesis research. Faculty are also welcome if there is room
