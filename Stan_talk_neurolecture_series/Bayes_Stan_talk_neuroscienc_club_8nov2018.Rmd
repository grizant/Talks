...
\begin{column}{0.5\textwidth}  
	...
	\begin{itemize}
		...
		\item Symptom of naive attempts to falisfy theories
	\end{itemize}
     \end{center}
\end{column}
\begin{column}{0.5\textwidth}
...
- I'm teaching a new course this Spring: Introduction to Bayesian Statistics (currently listed as MATH 429/629). Grad students will do a project based on your research interests.
